  ...
  context 'linux' do
    ...
    before do
      stub_request(:post, 'http://localhost:8081/service/rest/v1/script/get_user/run')
        ...
        .with(body: 'uploader-bot', headers: { 'Content-Type' => 'application/json' })
      ...
      stub_request(:post, 'http://localhost:8081/service/rest/v1/script/get_user/run')
        .with(basic_auth: %w[admin admin123])
        .with(body: 'uploader2-bot', headers: { 'Content-Type' => 'application/json' })
        .to_return(api_response(404),
      ...
      stub_request(:post, 'http://localhost:8081/service/rest/v1/script/get_user/run')
        .with(basic_auth: %w[admin admin123])
        .with(body: 'test-with-pass', headers: { 'Content-Type' => 'application/json' })
        .to_return(api_response(404),
      ...
      stub_request(:post, 'http://localhost:8081/service/rest/v1/script/get_user/run')
        .with(basic_auth: %w[admin admin123])
        .with(body: 'doesnotexist', headers: { 'Content-Type' => 'application/json' })
        .to_return(api_response(404),
      ...
      stub_request(:post, 'http://localhost:8081/service/rest/v1/script/get_user/run')
        .with(basic_auth: %w[admin admin123])
        .with(body: 'user_with_role', headers: { 'Content-Type' => 'application/json' })
        .to_return(api_response(404),

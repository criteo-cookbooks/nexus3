...
attribute :script_cookbook, kind_of: String, default: lazy { node['nexus3']['api']['script_cookbook'] }
...
attribute :ignore_failure, kind_of: [TrueClass, FalseClass], default: lazy { node['nexus3']['api']['ignore_failure'] }
